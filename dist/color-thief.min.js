 ...
 * @license
 */
var CanvasImage=function(a){a&&a.constructor&&"HTMLCanvasElement"===a.constructor.name?(this.canvas=a,this.context=this.canvas.getContext("2d")):(this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),this.canvas.width=a.width,this.canvas.height=a.height,this.context.drawImage(a,0,0,a.width,a.height)),this.width=this.canvas.width,this.height=this.canvas.height};CanvasImage.prototype.clear=function(){this.context.clearRect(0,0,this.width,this.height)},CanvasImage.prototype.update=function(a){this.context.putImageData(a,0,0)},CanvasImage.prototype.getPixelCount=function(){return this.width*this.height},CanvasImage.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)},CanvasImage.prototype.removeCanvas=function(){this.canvas.parentNode.removeChild(this.canvas)};var ColorThief=function(){};/*!
